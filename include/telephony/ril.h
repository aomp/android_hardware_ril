...
//[MMDC]
#define RIL_REQUEST_GET_PSDM_DECISION (RIL_REQUEST_MTK_BASE + 96)
#define RIL_REQUEST_CONFIRM_PS_SWITCH (RIL_REQUEST_MTK_BASE + 97)
#define RIL_REQUEST_CONFIRM_PS_SWITCH_ATTACH (RIL_REQUEST_MTK_BASE + 98)
#define RIL_REQUEST_RESET_MODE_AFTER_SWITCH (RIL_REQUEST_MTK_BASE + 99)
#define RIL_REQUEST_PS_REATTACH (RIL_REQUEST_MTK_BASE + 100)
...
#define RIL_UNSOL_STK_SETUP_MENU_RESET (RIL_UNSOL_MTK_BASE + 37)
#define RIL_UNSOL_APPLICATION_SESSION_ID_CHANGED (RIL_UNSOL_MTK_BASE + 38)
#define RIL_UNSOL_ECONF_SRVCC_INDICATION (RIL_UNSOL_MTK_BASE + 39)
//[MMDC]
#define RIL_UNSOL_PSDM_DECISION_CHANGED (RIL_UNSOL_MTK_BASE + 40)
#define RIL_UNSOL_SPECIAL_BAND_CHANGED (RIL_UNSOL_MTK_BASE + 41)
